...
/** @brief Values defining the state of the main sm */
#ifndef HAVE_ENUM_STATE_MACHINE_MODE
#define HAVE_ENUM_STATE_MACHINE_MODE
typedef enum STATE_MACHINE_MODE
{
   STANDBY_STATE=0, /* first state at power up | */
   PREACTIVE_STATE=1, /* second state, after activation of the vision algorithm | */
   ACTIVE_STATE=2, /* state which activates the vision algorithm | */
   FAULTED_STATE=3, /* state when something goes wrong | */
   STATE_MACHINE_MODE_ENUM_END=4, /*  | */
} STATE_MACHINE_MODE;
#endif

/** @brief Inside active, camera can be recording or taking photos */
#ifndef HAVE_ENUM_ACTIVE_SUBSTATE
#define HAVE_ENUM_ACTIVE_SUBSTATE
typedef enum ACTIVE_SUBSTATE
{
   RECORDING_STATE=0, /* Take and save video | */
   IMAGE_CAPTURE_STATE=1, /* Take photos | */
   PAUSED_STATE=2, /* Camera opened but not running algorithm | */
   ACTIVE_SUBSTATE_ENUM_END=3, /*  | */
} ACTIVE_SUBSTATE;
#endif
...
#include "./mavlink_msg_hover_games_status.h"
